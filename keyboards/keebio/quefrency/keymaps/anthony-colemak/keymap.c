...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    TD(GAME),   KC_PSCR, KC_LCTL,  KC_LALT, KC_LGUI, KC_APP,   HM_LSPC,           _______,HM_RSPC, KC_RALT, KC_RCTL, KC_RGUI,    KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_NUMS] = LAYOUT_65_with_macro(
    ...
    _______, _______, _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_PLUS, KC_7,   KC_8,     KC_9,     KC_COLN, KC_PIPE, _______, KC_PIPE, _______, \
  ...
  [_NAV] = LAYOUT_65_with_macro(
    ...
    _______, _______, RGB_TOG, RGB_MOD, _______, KC_UP,   _______, _______, _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END, _______, _______, _______, _______, \
  ...
  [_QWERTY] = LAYOUT_65_with_macro(
    ...
    TD(GAME),  _______,   KC_LCTL, KC_LALT, KC_LGUI, HM_MEN,   KC_SPC,           _______, KC_SPC,  KC_RALT, KC_RCTL, KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
  ),
};
