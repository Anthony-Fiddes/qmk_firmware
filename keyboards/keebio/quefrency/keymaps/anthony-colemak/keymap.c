...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    KC_F3,      KC_F4,   KC_TAB,   KC_Q,    KC_W,    KC_F,     KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN,    KC_LBRC, KC_RBRC, KC_BSLS,             KC_END, \
    KC_F5,      KC_F6,   KC_BSPC,  HM_A,    HM_R,    HM_S,     HM_T,    KC_D,    KC_H,    HM_N,    HM_E,    HM_I,    HM_O,       KC_QUOT, KC_ENT,                       KC_PGUP, \
    KC_F7,      KC_F8,   KC_LSFT,  KC_Z,    KC_X,    KC_C,     KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,    KC_RSFT, KC_UP,                        KC_PGDN, \
    TD(GAME),   KC_PSCR, KC_LCTL,  KC_LALT, KC_LGUI, HM_MEN,   HM_SPC,           _______, KC_SPC,  KC_RALT, KC_RCTL, KC_RGUI,    KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_NUMS] = LAYOUT_65_with_macro(
    ...
    _______, _______, _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_PLUS, KC_7,   KC_8,     KC_9,     KC_COLN, KC_PIPE, _______, _______, _______, \
    ...
    RESET,   _______, KC_TILD, _______, _______, _______, _______,          _______, KC_0,   _______,  _______,  _______, _______, _______, _______
  ),
  ...
  [_NAV] = LAYOUT_65_with_macro(
    ...
    _______, _______, KC_CAPS, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT, _______, _______, _______, \
  ...
  [_QWERTY] = LAYOUT_65_with_macro(
    ...
    TD(GAME),  _______,   KC_LCTL, KC_LALT, KC_LGUI, HM_MEN,   HM_SPC,           _______, KC_SPC,  KC_RALT, KC_RCTL, KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
  ),
};
